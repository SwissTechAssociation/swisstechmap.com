...
///////////////////////////////////////////////////////////////////////////
    ...
    $address = "contact@swisstechmap.com";
...
///////////////////////////////////////////////////////////////////////////
    ...
    if(isset($_SESSION['verify'])){ $session = $_SESSION['verify']; }
	$error = '';
		...
		if(mail($address, $e_subject, $msg, "From: $email\r\nReturn-Path: $email\r\n")) {
		 ...
		 echo "<p>Thanks for your message, we will reply to you in the next days!</p>";
		 echo "</div>";
		 echo "</fieldset>";
